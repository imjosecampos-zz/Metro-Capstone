...
<?php echo $content; ?>
<a class="sldbutton" href="<?php the_permalink(); ?>"><?php esc_attr_e('Read More', 'skt-design-agency');?></a>
</div>
</div>      
<?php $i++; } ?>       
<div class="clear"></div>        
...
?>
<h2 class="section_title"><?php esc_attr_e('Why Choose Us','skt-design-agency');?><span></span></h2>
<?php 
